...
function At2(e, t2 = "") {
  return ["opacity", "z-index", "line-height", "font-weight", "flex", "flex-grow", "flex-shrink", "order"].some((s4) => t2.endsWith(s4)) ? e : `${e}`.trim().split(" ").map((a2) => _2(a2) ? `${a2}px` : a2).join(" ");
}
function dt2(e) {
...
function Dt2(e = {}, t2) {
  if (p2(t2)) {
    let r = t2.trim();
    return z2(r, k3) ? r.replaceAll(k3, (s4) => F2(e, s4.replace(/{|}/g, ""))) : r;
  } else if (_2(t2)) return t2;
}
function Re(e, t2, r) {
...
//# sourceMappingURL=chunk-2GUCUE7J.js.map
