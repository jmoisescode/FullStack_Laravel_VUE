...
function zt(t2, e) {
  var o, n;
  if (t2) {
    let r = t2.parentElement, i2 = K(r), l = h(), d = t2.offsetParent ? t2.offsetWidth : J(t2), s4 = t2.offsetParent ? t2.offsetHeight : G2(t2), a2 = v((o = r == null ? void 0 : r.children) == null ? void 0 : o[0]), u = C((n = r == null ? void 0 : r.children) == null ? void 0 : n[0]), c = "", f2 = "";
    i2.left + a2 + d > l.width - P() ? i2.left < d ? e % 2 === 1 ? c = i2.left ? "-" + i2.left + "px" : "100%" : e % 2 === 0 && (c = l.width - d - P() + "px") : c = "-100%" : c = "100%", t2.getBoundingClientRect().top + u + s4 > l.height ? f2 = `-${s4 - u}px` : f2 = "0px", t2.style.top = f2, t2.style.insetInlineStart = c;
  }
}
function Jt(t2, e) {
  let o = getComputedStyle(t2).getPropertyValue("borderTopWidth"), n = o ? parseFloat(o) : 0, r = getComputedStyle(t2).getPropertyValue("paddingTop"), i2 = r ? parseFloat(r) : 0, l = t2.getBoundingClientRect(), s4 = e.getBoundingClientRect().top + document.body.scrollTop - (l.top + document.body.scrollTop) - n - i2, a2 = t2.scrollTop, u = t2.clientHeight, c = C(e);
...
//# sourceMappingURL=chunk-GQ2IHSZ3.js.map
